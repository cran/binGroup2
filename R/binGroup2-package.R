...
#' this assumption, we continue with the \code{binGroup} name for consistency.
#' 
...
#'                  group.sz = 3:30, obj.fn = "ET", alpha = 2)
#' summary(results1)}
#' 
...
#' set.seed(8791)
#' results3 <- opChar1(algorithm = "ID2", p = 0.02, Se = 0.95, 
#'                     Sp = 0.99, hier.config = config.mat, alpha = 0.5)
#' summary(results3)
#' 
